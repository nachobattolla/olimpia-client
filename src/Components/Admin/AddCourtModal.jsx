                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="my-3">
                                <select className="form-select" aria-label="Default select example" value={sport}
                                        onChange={(event) => {
                            ...
                            <input className="form-control" value={description} onChange={(event) => {
                                setDescription(event.target.value)
                            }}/>
                            <label> Hourly price </label>
                            <input className="form-control" type="number" value={price} onChange={(event) => {
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourMon}
                                           onChange={(event) => {
                                               setOpenHourMon(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourMon}
                                           onChange={(event) => {
                                               setCloseHourMon(event.target.value)
                                           }}/>
                                </div>
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourTue}
                                           onChange={(event) => {
                                               setOpenHourTue(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourTue}
                                           onChange={(event) => {
                                               setCloseHourTue(event.target.value)
                                           }}/>
                                </div>
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourWed}
                                           onChange={(event) => {
                                               setOpenHourWed(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourWed}
                                           onChange={(event) => {
                                               setCloseHourWed(event.target.value)
                                           }}/>
                                </div>
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourThur}
                                           onChange={(event) => {
                                               setOpenHourThur(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourThur}
                                           onChange={(event) => {
                                               setCloseHourThur(event.target.value)
                                           }}/>
                                </div>
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourFri}
                                           onChange={(event) => {
                                               setOpenHourFri(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourFri}
                                           onChange={(event) => {
                                               setCloseHourFri(event.target.value)
                                           }}/>
                                </div>
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourSat}
                                           onChange={(event) => {
                                               setOpenHourSat(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourSat}
                                           onChange={(event) => {
                                               setCloseHourSat(event.target.value)
                                           }}/>
                                </div>
                            ...
                            <div className="row align-items-start">
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={openHourSun}
                                           onChange={(event) => {
                                               setOpenHourSun(event.target.value)
                                           }}/>
                                ...
                                <div className="col">
                                    ...
                                    <input className="form-control" type="time" value={closeHourSun}
                                           onChange={(event) => {
                                               setCloseHourSun(event.target.value)
                                           }}/>
                                </div>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-success" data-bs-toggle="modal" onClick={() => onClick()}>
                                Save changes
                            </button>
                        </div>
                    </div>
